...
def junta_game(questoes):
    ...
    questoes_validadas = valida_questoes(questoes)
    sorteadas = []
    jogando = True
    a = 1
    pulo = 0
    ...
    while jogando == True:                           
        while a <= len(valores):   
            ...
            if a == 0:                                                               
                ...
                questao_sorteada = sorteia_questao(questoes_validadas,niveis[0])
                ...
                questao_sorteada = sorteia_questao_inedita(questoes_validadas,niveis[0],sorteadas)
                print(questao_para_texto(questao_sorteada,a))
                sorteadas.append(questao_sorteada)
                resposta = input('Qual a sua resposta?! ')
                if resposta == 'pular':
            ...
            if a == 4:                                                               
                ...
                questao_sorteada = sorteia_questao(questoes_validadas,niveis[1])
                print(questao_para_texto(questao_sorteada,a))
                sorteadas.append(questao_sorteada)
                resposta = input('Qual a sua resposta?! ')
                if resposta == 'pular':
                ...
                if a == 7:                                                               
                    ...
                    questao_sorteada = sorteia_questao(questoes_validadas,niveis[2])
                    print(questao_para_texto(questao_sorteada,a))
                    sorteadas.append(questao_sorteada)
                    resposta = input('Qual a sua resposta?! ')
                if resposta == 'pular':
                ...
                questao_sorteada = sorteia_questao_inedita(questoes_validadas,niveis[2],sorteadas)
                print(questao_para_texto(questao_sorteada,a))
                sorteadas.append(questao_sorteada)
                resposta = input('Qual a sua resposta?! ')
                if resposta == 'pular':
